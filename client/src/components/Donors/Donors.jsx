...
export default function Donors() {
  ...
  return (
    ...
    <div className="banner">
      ...
      <div className="box">
      <iframe title="vimeo-player" src="https://player.vimeo.com/video/68974299" width="300" height="360" frameborder="0" allowfullscreen></iframe></div>
      <div className="follow-us">
          ...
          <a href="#" target="_blank" class="social-icon"><img src="https://w7.pngwing.com/pngs/239/740/png-transparent-twitter-logo-icon-twitter-file-logo-social-media-news.png" height="50"></img></a>
</div>
      </div>
