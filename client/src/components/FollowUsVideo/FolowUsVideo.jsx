...
export default function FolowUsVideo() {
  return (
    ...
    <a className="social-icon" href="https://www.instagram.com/trinitys_place/" target="_blank"  ><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/768px-Instagram_logo_2016.svg.png"  height="50"></img></a>
    <a href="https://www.facebook.com/trinityplaceshelter/" target="_blank" className="social-icon" ><img src="https://facebookbrand.com/wp-content/uploads/2019/04/f_logo_RGB-Hex-Blue_512.png?w=512&h=512" height="50"></img></a>
